/**
 * @file transactions-table-expense.tsx
 * @description Tabla de transacciones de tipo Expense
 * @module components/pages/dashboard/transactions/fragments/transactions-table-expense
 */
...
export const TransactionsTableExpense = () => {
  const filters: TransactionFilters = useMemo(
    () => ({ type: ENUM_TRANSACTION_TYPE.EXPENSE }),
    []
  )
  ...
  const queryKey = useMemo(
    () => ['transactions', ENUM_TRANSACTION_TYPE.EXPENSE],
    []
  )
